...
export default function Profile() {
    ...
    const checks = [
      {
        ...
        done: Boolean(form.name.trim() && form.email.trim() && form.headline.trim()),
      },
      {
        id: 'education',
        label: 'Education',
        done: Boolean(educations.length > 0 && form.college.trim() && form.degree.trim()),
      },
      {
        id: 'career',
        label: 'Career Information',
        done: Boolean(form.targetRole.trim() && form.experience.trim() && form.about.trim()),
      },
      {
        id: 'skills',
        label: 'Skills (3+)',
  ...
  const handleCancel = () => {
    ...
    setForm({
      ...
      skills: user?.skills && user.skills.length > 0 ? user.skills : (latestExtra?.skills || []),
  ...
  return (
    <motion.div
      ...
      style={{ maxWidth: 1360, margin: '0 auto', width: '100%', paddingBottom: '3.5rem' }}
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <div>
            ...
            <p style={{ fontSize: '0.8125rem', color: 'var(--text-secondary)', margin: '3px 0 0 0' }}>
              Build a complete professional profile to get better interview preparation and career recommendations.
            </p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', flexWrap: 'wrap' }}>
          ...
          >
            <Eye size={15} style={{ color: '#14B8A6' }} />
            <span>Recruiter Preview</span>
          </motion.button>

          {!editing ? (
            <motion.button
              whileHover={{ scale: 1.02, boxShadow: '0 4px 16px rgba(139, 92, 246, 0.4)' }}
              whileTap={{ scale: 0.98 }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <motion.button
                whileHover={{ scale: 1.02, boxShadow: '0 4px 16px rgba(16, 185, 129, 0.4)' }}
                whileTap={{ scale: 0.98 }}
                onClick={handleSave}
                disabled={saving}
                style={{
      ...
      {completionStats.percentage < 100 && (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: 'var(--voxa-card-text)' }}>
                Complete your required information to unlock better interview and career recommendations.
              </span>
              <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', display: 'block' }}>
                Required fields are marked with <strong style={{ color: '#EF4444' }}>*</strong> (Full Name, Email,
                Headline, Target Role, College, Degree, Experience, 3+ Skills).
              </span>
            </div>
          </div>
      ...
      >
        {/* Soft background ambient gradient - Violet/Magenta subtle aura */}
        <div
          style={{
            position: 'absolute',
            top: -40,
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
            {/* Avatar with Gradient Ring and Camera icon */}
            <div
              style={{
                position: 'relative',
                width: 96,
            ...
            >
              ...
              >
                ...
                >
                  <Camera size={20} />
                  <span style={{ fontSize: '0.65rem', fontWeight: 700 }}>Upload</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              {form.headline ? (
                <p style={{ fontSize: '0.925rem', fontWeight: 600, color: '#8B5CF6', margin: '4px 0 8px 0' }}>
                  {form.headline}
                </p>
              ) : (
              ...
              >
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem' }}>
                  ...
                  {form.targetRole || 'Target Role: Not added'} {form.experience ? `• ${form.experience}` : ''}
                </span>

                {(form.degree || form.college) && (
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.35rem' }}>
                    <GraduationCap size={14} style={{ color: '#8B5CF6' }} />
                    {form.degree || form.college} {form.fieldOfStudy ? `in ${form.fieldOfStudy}` : ''}
                  </span>
                )}
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <span
                style={{
                  fontSize: '1.15rem',
                  fontWeight: 800,
                  color: completionStats.percentage >= 80 ? '#10B981' : '#F59E0B',
                }}
              >
            ...
            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
              {completionStats.percentage >= 80 ? '✓ Ready for Mock Interviews' : '⚡ Complete required sections'}
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div className="voxa-card" style={{ padding: '1.5rem', borderRadius: '20px' }}>
            <SectionHeader
              icon={UserIcon}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }} className="field-grid">
              {renderField({
                label: 'Full Name',
                value: form.name,
              ...
              {renderField({
                label: 'City & Location',
                value: form.city,
                onChange: (v) => setForm((c) => ({ ...c, city: v, location: `${v}, ${c.country}` })),
                icon: MapPin,
              ...
              {renderField({
                label: 'Country',
                value: form.country,
                onChange: (v) => setForm((c) => ({ ...c, country: v, location: `${c.city}, ${v}` })),
                icon: Globe,
          ...
          <div className="voxa-card" style={{ padding: '1.5rem', borderRadius: '20px' }}>
            ...
            <div
              style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', marginBottom: '1rem' }}
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  {editing ? (
                    <select
                      ...
                      className="input"
                      style={{ width: '100%', paddingLeft: '2.6rem', borderRadius: 12, minHeight: 46 }}
                    >
              ...
              <div>
                ...
                {editing ? (
                  <select
                    ...
                    onChange={(e) => setForm((c) => ({ ...c, preferredJobType: e.target.value }))}
                    className="input"
                  ...
                  <div
                    className="input"
                    style={{ width: '100%', minHeight: 46, display: 'flex', alignItems: 'center', borderRadius: 12 }}
                  >
              ...
              <div>
                ...
                {editing ? (
                  <select
                    ...
                    onChange={(e) => setForm((c) => ({ ...c, preferredLocation: e.target.value }))}
                    className="input"
                    style={{ width: '100%', borderRadius: 12, minHeight: 46 }}
                  >
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              {editing ? (
                <textarea
                  ...
                  onChange={(e) => setForm((c) => ({ ...c, careerObjective: e.target.value }))}
                  placeholder="State your near-term professional goals and what direction you want your career to take..."
                  className="input"
                  style={{ width: '100%', minHeight: 75, borderRadius: 12, padding: '0.75rem', lineHeight: 1.6 }}
                />
              ) : (
                <div
                  style={{
            ...
            <div>
              ...
              {editing ? (
                <textarea
                  value={form.about}
                  onChange={(e) => setForm((c) => ({ ...c, about: e.target.value }))}
                  placeholder="Summarize your background, core technical focus and what problems you love solving..."
                  className="input"
                  style={{ width: '100%', minHeight: 110, borderRadius: 12, padding: '0.85rem', lineHeight: 1.6 }}
                />
              ) : (
                <div
                  style={{
          ...
          <div className="voxa-card" style={{ padding: '1.5rem', borderRadius: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
              {educations.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '1.5rem', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
                  Not added{editing ? '. Click "Add Education" above to add your degree.' : ''}
                </div>
              ) : (
                educations.map((edu) => (
                  <div
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.85rem' }}>
                      ...
                      <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                          <h4 style={{ fontSize: '0.95rem', fontWeight: 800, color: 'var(--voxa-card-text)', margin: 0 }}>
                        ...
                        {edu.cgpa && (
                          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: '4px' }}>
                            Performance: <strong style={{ color: 'var(--voxa-card-text)' }}>{edu.cgpa}</strong>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    {editing && (
                      <button
                        onClick={() => setEducations((curr) => curr.filter((e) => e.id !== edu.id))}
            ...
            {showAddEducation && editing && (
              ...
              >
                <h4 style={{ fontSize: '0.875rem', fontWeight: 700, marginBottom: '0.75rem' }}>Add New Education Entry</h4>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.75rem' }} className="field-grid">
                  <input
                    placeholder="College / University *"
                    value={newEdu.college}
                    onChange={(e) => setNewEdu((c) => ({ ...c, college: e.target.value }))}
                    className="input"
                  ...
                  <input
                    ...
                    value={newEdu.degree}
                    onChange={(e) => setNewEdu((c) => ({ ...c, degree: e.target.value }))}
                    className="input"
                    style={{ borderRadius: 10 }}
                  />
                  <input
                    ...
                    onChange={(e) => setNewEdu((c) => ({ ...c, fieldOfStudy: e.target.value }))}
                    className="input"
                    style={{ borderRadius: 10 }}
                  />
                  <input
                    ...
                    onChange={(e) => setNewEdu((c) => ({ ...c, graduationYear: e.target.value }))}
                    className="input"
                    style={{ borderRadius: 10 }}
                  />
                  <input
                    ...
                    value={newEdu.cgpa}
                    onChange={(e) => setNewEdu((c) => ({ ...c, cgpa: e.target.value }))}
                    className="input"
                    style={{ borderRadius: 10 }}
                  />
                </div>
                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem', marginTop: '0.75rem' }}>
                  <button onClick={() => setShowAddEducation(false)} className="btn btn-ghost btn-sm">
                    Cancel
                  </button>
                  <button
                    onClick={() => {
                      ...
                      setShowAddEducation(false)
                      setNewEdu({ college: '', degree: 'B.Tech', fieldOfStudy: '', graduationYear: '2025', cgpa: '' })
          ...
          <div className="voxa-card" style={{ padding: '1.5rem', borderRadius: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {projects.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '1.5rem', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
                  Not added{editing ? '. Click "Add Project" above to add your projects.' : ''}
                </div>
              ) : (
                projects.map((proj) => (
                  <div
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem' }}>
                      <div>
                        ...
                        <p style={{ fontSize: '0.8125rem', color: 'var(--text-secondary)', lineHeight: 1.5, margin: '6px 0 10px 0' }}>
                          {proj.description}
                        </p>
                        ...
                        <div style={{ display: 'flex', gap: '0.85rem', fontSize: '0.75rem', fontWeight: 600 }}>
                          {proj.githubUrl && (
                            ...
                            >
                              <GithubIcon size={14} /> Code Repository <ExternalLink size={11} />
                            </a>
                          )}
                          {proj.liveUrl && (
                            <a
                            ...
                            >
                              <Globe size={14} /> Live Demo <ExternalLink size={11} />
                            </a>
                          )}
                        </div>
                      </div>
                      ...
                      {editing && (
                        <button
                          onClick={() => setProjects((curr) => curr.filter((p) => p.id !== proj.id))}
                          style={{ background: 'transparent', border: 'none', color: '#EF4444', cursor: 'pointer', padding: 4 }}
            ...
            {showAddProject && editing && (
              ...
              >
                <h4 style={{ fontSize: '0.875rem', fontWeight: 700, marginBottom: '0.75rem' }}>Add Featured Project</h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                  <input
                    placeholder="Project Name *"
                    value={newProject.title}
                    onChange={(e) => setNewProject((c) => ({ ...c, title: e.target.value }))}
                    className="input"
                    style={{ borderRadius: 10 }}
                  />
                  <textarea
                    ...
                    onChange={(e) => setNewProject((c) => ({ ...c, description: e.target.value }))}
                    className="input"
                    style={{ borderRadius: 10, minHeight: 70 }}
                  />
                  <input
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.65rem' }}>
                    <input
                      ...
                      onChange={(e) => setNewProject((c) => ({ ...c, githubUrl: e.target.value }))}
                      className="input"
                      style={{ borderRadius: 10 }}
                    />
                    <input
                      ...
                      onChange={(e) => setNewProject((c) => ({ ...c, liveUrl: e.target.value }))}
                      className="input"
                      style={{ borderRadius: 10 }}
                    />
                  </div>
                  ...
                  <button
                    onClick={() => {
                      ...
                      const stack = projectTechInput
                        ? projectTechInput.split(',').map((s) => s.trim()).filter(Boolean)
                        : ['Python']
                      setProjects((curr) => [
                        ...curr,
                        {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              {completionStats.checks.map((chk) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '12px',
                    backgroundColor: chk.done ? 'rgba(16, 185, 129, 0.06)' : 'rgba(245, 158, 11, 0.06)',
                    border: chk.done ? '1px solid rgba(16, 185, 129, 0.2)' : '1px solid rgba(245, 158, 11, 0.2)',
                  }}
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.55rem' }}>
                    ...
                    <span style={{ fontSize: '0.8125rem', fontWeight: 600, color: 'var(--voxa-card-text)' }}>
                      {chk.label}
                    </span>
                  </div>
                ...
                <div style={{ display: 'flex', gap: '0.45rem' }}>
                  <div style={{ position: 'relative', flex: 1 }}>
                    ...
                    {editing ? (
                      <input
                        value={form.github}
                        onChange={(e) => setForm((c) => ({ ...c, github: e.target.value }))}
                        placeholder="https://github.com/yourhandle"
                        className="input"
                        style={{ width: '100%', paddingLeft: '2.6rem', borderRadius: 12 }}
                      />
                    ) : (
                      <div
                        className="input"
          ...
          <div className="voxa-card" style={{ padding: '1.5rem', borderRadius: '20px' }}>
            ...
            {form.resumeFilename ? (
              ...
              >
                <FileText size={28} color="#F59E0B" style={{ margin: '0 auto 0.5rem', opacity: 0.8 }} />
                <div style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--voxa-card-text)' }}>
                  No resume uploaded yet
                </div>
                <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', margin: '4px 0 1rem 0' }}>
                  Upload a resume to get automatic skill extraction and ATS analysis.
                </p>
                <button
                  onClick={() => resumeInputRef.current?.click()}
          ...
          <div className="voxa-card" style={{ padding: '1.5rem', borderRadius: '20px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
              {languages.length === 0 ? (
                <div style={{ padding: '1rem 0', color: 'var(--text-muted)', fontSize: '0.8125rem' }}>
                  Not added{editing ? '. Click "Add Lang" above to add languages.' : ''}
                </div>
              ) : (
                languages.map((lang) => (
                  <div
                  ...
                  >
                    ...
                    {editing && (
                      <button
                        onClick={() => setLanguages((curr) => curr.filter((l) => l.language !== lang.language))}
            ...
            {showAddLanguage && editing && (
              ...
              >
                <input
                  ...
                  onChange={(e) => setNewLang((c) => ({ ...c, language: e.target.value }))}
                  className="input"
                  style={{ flex: 1, borderRadius: 8 }}
                />
                <select
                  value={newLang.proficiency}
                  onChange={(e) => setNewLang((c) => ({ ...c, proficiency: e.target.value }))}
                  className="input"
                ...
                <button
                  onClick={() => {
                    ...
                    setLanguages((curr) => [
                      ...curr,
                      { language: newLang.language || '', proficiency: newLang.proficiency || 'Fluent' },
                    ])
                  ...
                  className="btn btn-primary btn-sm"
                  style={{ background: '#EC4899', borderRadius: 8 }}
                >
                  Add
                </button>
              </div>
          ...
          <div className="voxa-card" style={{ padding: '1.5rem', borderRadius: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {certifications.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '1.5rem', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
                  Not added{editing ? '. Click "Add Cert" above to add your certifications.' : ''}
                </div>
              ) : (
                certifications.map((cert) => (
                  ...
                  >
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontSize: '0.8125rem', fontWeight: 700, color: 'var(--voxa-card-text)' }}>
                        {cert.name}
                      </div>
                      <div style={{ fontSize: '0.6875rem', color: 'var(--text-muted)', marginTop: '2px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      ...
                      {editing && (
                        <button
                          onClick={() => setCertifications((curr) => curr.filter((c) => c.id !== cert.id))}
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewCert((c) => ({ ...c, credentialUrl: e.target.value }))}
                    className="input"
                    style={{ borderRadius: 8 }}
                  />
                  <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.5rem', marginTop: '0.35rem' }}>
                    <button onClick={() => setShowAddCertification(false)} className="btn btn-ghost btn-sm">
                      Cancel
                    </button>
                    <button
                      onClick={() => {
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: '1.25rem', fontWeight: 800, margin: 0 }}>{form.name}</h4>
                    <p style={{ color: '#8B5CF6', fontWeight: 600, fontSize: '0.9rem', margin: '2px 0 4px 0' }}>
                      {form.headline}
                    </p>
                    <div
                      style={{
                ...
                <div>
                  ...
                  <p style={{ fontSize: '0.875rem', lineHeight: 1.6, color: 'var(--voxa-card-text)', margin: 0 }}>
                    {form.about}
                  </p>
                </div>
              ...
              <div style={{ marginTop: '2rem', display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
                <button onClick={() => setPreviewOpen(false)} className="btn btn-ghost">
                  Close Preview
                </button>
                <button
                  onClick={() => {
...
function SectionHeader({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.25rem' }}>
      ...
      <div>
        <h3 style={{ fontSize: '1rem', fontWeight: 800, color: 'var(--voxa-card-text)', margin: 0 }}>
          {title}
        </h3>
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.45rem' }}>
        ...
        {editing && isValid && (
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 2, fontSize: '0.6875rem', color: '#10B981', fontWeight: 700 }}>
            <Check size={12} /> Valid
          </span>
        )}
      </div>
        ...
        {editing ? (
          <input
            ...
            style={{
              ...
              borderRadius: 12,
              minHeight: 46,
              borderColor: error ? '#EF4444' : isValid ? 'rgba(16, 185, 129, 0.4)' : undefined,
            }}
          />
        ) : (
          <div
      ...
      {editing && error && (
        <span style={{ fontSize: '0.6875rem', color: '#EF4444', marginTop: 4, display: 'block', fontWeight: 600 }}>
          {error}
        </span>
      )}
    </div>
